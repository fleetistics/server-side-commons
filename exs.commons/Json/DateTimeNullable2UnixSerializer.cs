...
{
    public class DateTimeNullable2UnixSerializer : JsonConverter<DateTime?>
    {
        ...
        public override void Write(Utf8JsonWriter writer, DateTime? value, JsonSerializerOptions options)
        {
            ...
            else writer.WriteNumberValue(new DateTimeOffset(value.Value, TimeSpan.Zero).ToUnixTimeSeconds());
        }
    }
}
